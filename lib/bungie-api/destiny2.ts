...
export async function getApiProfileRecords(): Promise<
  DestinyProfileResponse | undefined
> {
  console.log("getting catalyst records");
  ...
  try {
    ...
    console.log(
      ">>>>>>> characterRecords",
      profile?.Response?.characterRecords
    );
    console.log(">>>>>>> profileRecords", profile?.Response?.profileRecords);
  ...
  // console.log(">>>>>>> lel oh lel", profile?.Response);
}
